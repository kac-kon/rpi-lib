...
from api import CheckStatus, RGBGet, RGBSet
...
if __name__ == "__main__":
    ...
    api.add_resource(CheckStatus(hand), "/checkStatus")
    api.add_resource(RGBSet(hand), "/RGB/<int:red>/<int:green>/<int:blue>")
    api.add_resource(RGBGet(hand), "/RGB")
