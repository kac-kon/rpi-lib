...
class Displays:
    def __init__(self):
        ...
        self._lcd0 = drivers.lcd_driver.lcd(constants.LCD.id(0), backlight = constants.INITIALS.LCD2_BACKLIGHT)
        self._lcd1 = drivers.lcd_driver.lcd(constants.LCD.id(1), backlight = constants.INITIALS.LCD4_BACKLIGHT)
